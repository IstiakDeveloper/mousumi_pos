                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Transaction History
                            </h3>
                            <div class="space-y-3">
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-600 dark:text-gray-400">Original Category:</span>
                                    <span class="text-gray-900 dark:text-gray-200">
                                        {{ extraIncome.category?.name || 'Uncategorized' }}
                                    </span>
                                </div>
                                <div class="flex justify-between text-sm">
                                ...
                                <div v-if="hasChanges" class="border-t dark:border-gray-600 pt-3">
                                    <div class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Changes
                                        Preview:
                                    </div>
                                    <div class="space-y-2">
...
const form = useForm({
  ...
  category_id: props.extraIncome.category_id || '',  // Add this
...
// Add category to hasChanges computed
const hasChanges = computed(() => {
  return form.bank_account_id !== props.extraIncome.bank_account_id ||
    form.category_id !== props.extraIncome.category_id ||  // Add this
