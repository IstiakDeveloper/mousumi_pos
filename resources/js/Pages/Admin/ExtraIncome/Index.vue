    ...
    <AdminLayout>
      <template #header>
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <Link
            :href="route('admin.extra-incomes.create')"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  ...
                  <dd class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ formatCurrency(statistics.totalIncome) }}</dd>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  ...
                  <dd class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ formatCurrency(statistics.thisMonthIncome) }}</dd>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  ...
                  <dd class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ formatCurrency(statistics.averageIncome) }}</dd>
                </div>
              </div>
            </div>
              ...
              <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                >
                  <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ formatTime(income.created_at) }}</div>
                  </td>
                  <td class="px-6 py-4">
      ...
      <div class="p-6">
        ...
        <div class="mt-4 bg-gray-50 dark:bg-gray-700 rounded-md p-4">
          <div class="text-sm">
            ...
            <div><span class="font-medium">Amount:</span> {{ formatCurrency(deleteModal.income?.amount) }}</div>
